...
const App = () => {
  ...
  const handleSubmit = () => {
    ...
    if (isNaN(valorGasolina) || isNaN(kmPorLitro) || isNaN(kmRodados) || isNaN(totalDoDia)) {
      alert('Por favor, insira valores numéricos válidos.');
      return;
    }

    const custoKM = formValues.valorGasolina / formValues.kmPorLitro;
    console.log(`O custo por KM é: ${custoKM}`);
    const custoDia = formValues.kmRodados * custoKM;
    const gastoPorc = (custoDia * 100) / formValues.totalDoDia;
